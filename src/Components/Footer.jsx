    ...
    <div className="bg-[#FAF8F5] font-sans text-[#1A1A1A] flex flex-col justify-between ">
      ...
      <section className="px-6 py-5 md:px-10 lg:px-20 flex-grow flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start w-full max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col justify-center h-full">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a href="#medium" className="flex items-center gap-2 border border-gray-300 text-xs text-gray-600 rounded-full px-4 py-2 hover:bg-gray-100 transition-colors">
                  <span className="w-4 h-4 rounded-full border border-gray-400 flex items-center justify-center text-[10px]">M</span>
                  Meduim
                </a>
                <a href="#dribbble" className="flex items-center gap-2 border border-gray-300 text-xs text-gray-600 rounded-full px-4 py-2 hover:bg-gray-100 transition-colors">
                  <span className="w-4 h-4 rounded-full border border-gray-400 flex items-center justify-center text-[10px]">D</span>
                  Dripple
                </a>
                <a href="#behance" className="flex items-center gap-2 border border-gray-300 text-xs text-gray-600 rounded-full px-4 py-2 hover:bg-gray-100 transition-colors">
                  <span className="w-4 h-4 rounded-full border border-gray-400 flex items-center justify-center text-[10px]">B</span>
                  Behance
                </a>
              </div>
            </div>
          ...
          <div className="bg-[#FAF8F5] lg:bg-transparent rounded-3xl p-0 sm:p-8 lg:p-0 w-full">
            <form onSubmit={handleSubmit} className="bg-[#FAF8F5] border border-gray-200/60 rounded-[2rem] p-8 md:p-12 shadow-sm flex flex-col gap-8">
              
              {/* Full Width Name Input */}
              <div className="relative border-b border-gray-300 pb-2 focus-within:border-gray-800 transition-colors">
                <label className="block text-xs font-serif text-gray-400 mb-1">Name</label>
                <input 
                  type="text" 
                  name="name"
                  value={formData.name}
              ...
              {/* Grid split for Phone and Email on Desktop layouts */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="relative border-b border-gray-300 pb-2 focus-within:border-gray-800 transition-colors">
                  <label className="block text-xs font-serif text-gray-400 mb-1">Phone</label>
                  <input 
                    type="tel" 
                    name="phone"
                ...
                <div className="relative border-b border-gray-300 pb-2 focus-within:border-gray-800 transition-colors">
                  <label className="block text-xs font-serif text-gray-400 mb-1">Email</label>
                  <input 
                    type="email" 
                    name="email"
              ...
              {/* Message Block Area */}
              <div className="relative border-b border-gray-300 pb-2 focus-within:border-gray-800 transition-colors">
                <label className="block text-xs font-serif text-gray-400 mb-1">Message</label>
                <input 
                  type="text" 
                  name="message"
      ...
      <footer className="border-t border-gray-200 bg-[#FAF8F5] px-6 py-8 md:px-16 lg:px-24 w-full">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Social Utility Glyphs */}
          <div className="flex items-center gap-4 text-gray-600 order-2 md:order-3">
            <a href="#facebook" className="hover:text-black transition-colors text-sm" aria-label="Facebook">
              &#62220;
            </a>
            <a href="#x" className="hover:text-black transition-colors text-sm" aria-label="X (Twitter)">
              &#120143;
            </a>
            <a href="#instagram" className="hover:text-black transition-colors text-sm" aria-label="Instagram">
              &#9775;
            </a>
          </div>
